    ...
    public class SchoolInitializer : DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            var instructors = new List<Instructor>
            {
                ...
                new Instructor { FirstMidName = "Roger", LastName = "Zheng", HireDate = DateTime.Parse("2004-01-12") }
            };
            ...
            {
                new Course {CourseID=1050, Title="Chemistry", Credits=3, DepartmentID = 3, Instructor = new List<Instructor>() },
                new Course {CourseID=4022, Title="Microeconomics", Credits=3, DepartmentID = 4, Instructor = new List<Instructor>() },
                new Course {CourseID=4041, Title="Microeconomics", Credits=3, DepartmentID = 4, Instructor = new List<Instructor>() },
                new Course {CourseID=1045, Title="Calculus", Credits=4, DepartmentID = 2, Instructor = new List<Instructor>() },
                new Course {CourseID=3141, Title="Trigonometry", Credits=4, DepartmentID = 2, Instructor = new List<Instructor>() },
                new Course {CourseID=2021, Title="Composition", Credits=3, DepartmentID = 1, Instructor =new List<Instructor>() },
                new Course {CourseID=2042, Title="Literature", Credits=4, DepartmentID = 1, Instructor = new List<Instructor>() }
            };
            courses.ForEach(s => context.Courses.Add(s));
            context.SaveChanges();
            courses[0].Instructor.Add(instructors[0]);
            courses[0].Instructor.Add(instructors[1]);
            courses[1].Instructor.Add(instructors[2]);
            courses[2].Instructor.Add(instructors[2]);
            courses[3].Instructor.Add(instructors[3]);
            courses[4].Instructor.Add(instructors[3]);
            courses[5].Instructor.Add(instructors[3]);
            courses[6].Instructor.Add(instructors[3]);
            context.SaveChanges();

            var enrollments = new List<Enrollment>
            {
                new Enrollment {StudentID=1, CourseID=1050, Grade=1 }, //jika menggunakan enum maka Grade=Grade.A
